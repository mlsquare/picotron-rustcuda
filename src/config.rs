//! Configuration management for PicoTron RustCUDA

use serde::{Deserialize, Serialize};
use std::path::Path;
use anyhow::Result;

/// PicoTron RustCUDA configuration
...
pub struct CudaConfig {
    ...
    pub kernel_optimization_level: u32,
}
...
impl PicoTronConfig {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        // Validate CUDA config
        if self.cuda.memory_pool_size_mb == 0 {
            return Err(anyhow::anyhow!("memory_pool_size_mb must be > 0"));
        }
